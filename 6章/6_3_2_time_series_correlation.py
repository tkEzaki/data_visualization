...
# ax1.legend()
fig1.tight_layout()
fig1.savefig('6_3_2_1_time_series_line_plot.png', dpi=300)
fig1.savefig('6_3_2_1_time_series_line_plot.svg', dpi=300)
...
# ax2.legend()
fig2.tight_layout()
fig2.savefig('6_3_2_2_time_series_scatter_plot.png', dpi=300)
fig2.savefig('6_3_2_2_time_series_scatter_plot.svg', dpi=300)
