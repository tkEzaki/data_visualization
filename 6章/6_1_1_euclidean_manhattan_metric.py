...
ax.text(x2 + 0.4, (y1 + y2) / 2 - 0.15, f'{abs(y2-y1)}', verticalalignment='bottom', horizontalalignment='right', color='salmon')
...
plt.savefig('6_1_1_euclidean_manhattan_metric.png', bbox_inches='tight', dpi=300)
plt.savefig('6_1_1_euclidean_manhattan_metric.svg', bbox_inches='tight', dpi=300)
