...
sns.heatmap(heatmap_data, annot=True, fmt=".4f", cmap='coolwarm', xticklabels=range(1, 7), yticklabels=range(1, 7), vmin=0.0139, vmax=0.031)
# plt.title("Dice Roll Heatmap")
plt.xlabel("サイコロBの出目")
plt.ylabel("サイコロAの出目")
plt.tight_layout()
plt.savefig("dice_heatmap_2.png", dpi=300)
plt.show()
...
plt.ylabel("相対頻度")
plt.tight_layout()
plt.savefig("dice_bar_updated.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("dice_bar_2.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("dice_time_series.png", dpi=300)
plt.show()
