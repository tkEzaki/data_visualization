...
sns.heatmap(heatmap_data_sampled, annot=True, fmt=".3f", annot_kws={"size": 10}, cmap='coolwarm', xticklabels=range(1, 7), yticklabels=range(1, 7))
# plt.title("二つのサイコロを1,000,000回振った結果のまとめ")
plt.xlabel("サイコロBの出目")
plt.ylabel("サイコロAの出目")
plt.tight_layout()
plt.savefig("6_4_1_1_dice_experiment_1_heatmap.png", dpi=300)
plt.savefig("6_4_1_1_dice_experiment_1_heatmap.svg", dpi=300)
...
plt.ylabel("相対頻度")
plt.tight_layout()
plt.savefig("6_4_1_2_dice_experiment_1_bar.png", dpi=300)
plt.savefig("6_4_1_2_dice_experiment_1_bar.svg", dpi=300)
