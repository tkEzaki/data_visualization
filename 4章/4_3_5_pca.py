...
axs[1].set_ylim(0, 1)
axs[1].set_xticklabels([f'PC {i+1}' for i in range(len(explained_variance_all))], rotation=30, ha='right')
# axs[1].set_ylabel('Explained variance ratio')


plt.tight_layout()
plt.savefig('4_3_5_pca.png', dpi=300)
plt.savefig('4_3_5_pca.svg', dpi=300)
plt.show()
