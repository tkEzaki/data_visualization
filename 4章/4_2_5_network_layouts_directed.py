...
for i, layout in enumerate(layouts):
    for j, graph in enumerate(graphs):
        ...
        nx.draw(graph, pos, with_labels=False, ax=ax, node_size=40, edge_color="gray", node_color=colors[i], arrows=True)  # グラフを描画
        # if i == 0:
...
plt.tight_layout()
plt.savefig("4_2_5_network_layouts_directed.png", dpi=300)
plt.savefig("4_2_5_network_layouts_directed.svg", dpi=300)
