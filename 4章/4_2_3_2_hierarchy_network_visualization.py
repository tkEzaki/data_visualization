...
nx.draw(G, pos, with_labels=True, node_color='gray', node_size=500, edge_color='black', font_color="white", font_size=16)
plt.savefig("4_2_3_2_hierarchy_network_visualization.png", dpi=300)
plt.show()
