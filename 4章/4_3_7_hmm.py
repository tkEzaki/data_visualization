...
for i in range(n_components):
    ...
    sns.heatmap(model.covars_[i], ax=ax, cmap=cmap, norm=norm, cbar=True, cbar_kws={"ticks": [-3, 0, 3]})
...
# plt.tight_layout()
plt.savefig('4_3_7_hmm.png', dpi=300)
plt.savefig('4_3_7_hmm.svg', dpi=300)
