...
plt.savefig('4_3_6_2_digit_image.svg', dpi=300)
...
plt.tight_layout()
plt.savefig('4_3_6_1_dimensionality_reduction.png', dpi=300)
plt.savefig('4_3_6_1_dimensionality_reduction.svg', dpi=300)
