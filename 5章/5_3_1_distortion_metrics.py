...
plt.tight_layout()
plt.savefig('5_3_1_1_distorted_dist_histograms.png', dpi=300)
plt.savefig('5_3_1_1_distorted_dist_histograms.svg', dpi=300)
...
for ax in axes:
    ax.set_xticklabels(['分布１', '分布２', '分布３'], rotation=45, ha='right')
...
plt.savefig('5_3_1_2_dist_metric_bar_charts.svg', dpi=300)  # 画像の保存
