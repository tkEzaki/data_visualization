...
axes[0, 0].set_title('セトサ', fontsize=12)
...
# axes[1, 0].set_title('セトサ (花弁長 vs がく片長さ)', fontsize=12)
...
axes[0, 1].set_title('バージカラー', fontsize=12)
axes[0, 1].set_xlabel('花弁の長さ [cm]')
axes[0, 1].set_ylabel('')
# axes[1, 1].set_title('バージカラー (花弁長 vs がく片長さ)', fontsize=12)
...
axes[0, 2].set_title('バージニカ', fontsize=12)
axes[0, 2].set_xlabel('花弁の長さ [cm]')
axes[0, 2].set_ylabel('')
# axes[1, 2].set_title('バージニカ (花弁長 vs がく片長さ)', fontsize=12)
axes[1, 2].set_xlabel('花弁の長さ [cm]')
axes[1, 2].set_ylabel('')

# グラフを表示
plt.tight_layout()
plt.savefig('8_1_8_panel_layout_good.png', dpi=300)
plt.show()
