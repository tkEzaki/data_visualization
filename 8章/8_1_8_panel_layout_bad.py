...
axes[0, 0].set_title('セトサ (花弁長 vs 花弁幅)', fontsize=12)
...
axes[0, 1].set_title('セトサ (がく片長さ vs 花弁長)', fontsize=12)
...
axes[0, 2].set_title('バージカラー (花弁長 vs 花弁幅)', fontsize=12)
axes[0, 2].set_xlabel('花弁の長さ [cm]')
axes[0, 2].set_ylabel('花弁の幅 [cm]')
axes[1, 0].set_title('バージカラー (がく片長さ vs 花弁長)', fontsize=12)
...
axes[1, 1].set_title('バージニカ (花弁長 vs 花弁幅)', fontsize=12)
axes[1, 1].set_xlabel('花弁の長さ [cm]')
axes[1, 1].set_ylabel('花弁の幅 [cm]')
axes[1, 2].set_title('バージニカ (がく片長さ vs 花弁長)', fontsize=12)
axes[1, 2].set_xlabel('がく片の長さ [cm]')
axes[1, 2].set_ylabel('花弁の長さ [cm]')

# グラフを表示
plt.tight_layout()
plt.savefig('8_1_8_panel_layout_bad.png', dpi=300)
plt.show()
