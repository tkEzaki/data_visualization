...
def draw_bar_graph(prefectures, shipment):
    ...
    plt.xlim(-0.5, 46.5)
    plt.tight_layout()
    plt.savefig("1_2_5_logistics_bar.png", dpi=300)
    plt.savefig("1_2_5_logistics_bar.svg", dpi=300)
    plt.show()
...
def draw_ordered_by_code_bar_graph(prefectures_ordered_by_code, ordered_shipments_by_code):
    ...
    plt.xlim(-0.5, 46.5)
    plt.tight_layout()
    plt.savefig("1_2_5_logistics_bar_ordered_by_code.png", dpi=300)
    plt.savefig("1_2_5_logistics_bar_ordered_by_code.svg", dpi=300)
    plt.show()
...
def draw_japan_map(prefectures, shipment):
    ...
    plt.tight_layout()
    plt.savefig("1_2_5_logistics_map.png", dpi=300)
